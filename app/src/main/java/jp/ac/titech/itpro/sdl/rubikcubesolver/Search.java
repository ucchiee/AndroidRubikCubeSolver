 ...
 * A much faster and smaller implementation of Two-Phase Algorithm.<br>
...
public class Search {
     ...
     *                 You can also use {@link jp.ac.titech.itpro.sdl.rubikcubesolver.Tools#fromScramble(java.lang.String s)} to convert the scramble string to the
