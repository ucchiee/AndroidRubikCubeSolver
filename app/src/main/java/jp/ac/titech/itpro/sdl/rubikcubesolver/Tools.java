...
public class Tools {
     ...
     *
     * @see jp.ac.titech.itpro.sdl.rubikcubesolver.Tools#saveTo(java.io.DataOutput)
     */
     ...
     *
     * @see jp.ac.titech.itpro.sdl.rubikcubesolver.Tools#initFrom(java.io.DataInput)
     */
     ...
     *
     * The random source can be set by {@link jp.ac.titech.itpro.sdl.rubikcubesolver.Tools#setRandomSource(java.util.Random)}
     *
     ...
     *
     * @see jp.ac.titech.itpro.sdl.rubikcubesolver.Tools#setRandomSource(java.util.Random)
     * @see jp.ac.titech.itpro.sdl.rubikcubesolver.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)
     */
     ...
     *
     * @param facelets is the cube definition string , see {@link jp.ac.titech.itpro.sdl.rubikcubesolver.Search#solution(java.lang.String facelets, int maxDepth, long timeOut, long timeMin, int verbose)}
